...
import FireRiskChart from '../components/FireRiskChart'
import FireSpreadMap from '../components/FireSpreadMap'
import SatelliteImagery from '../components/SatelliteImagery'
import ResourceAllocation from '../components/ResourceAllocation'
import WindAnalysisDisplay from '../components/WindAnalysisDisplay'
import BiodiversityRiskDisplay from '../components/BiodiversityRiskDisplay'
import TacticalPlansDisplay from '../components/TacticalPlansDisplay'
...
const Dashboard: React.FC = () => {
      ...
      if (currentWeather && !weatherLoading) {
        try {
          ...
          const [
            ...
            azureService.predictFireRisk(currentWeather, location),
  ...
  }, [currentWeather, weatherLoading, location])
    ...
    <div className="space-y-4 sm:space-y-8">
      ...
      <div className="text-center">
        ...
        <p className="text-xs sm:text-sm text-gray-600">
          Análisis avanzado con Microsoft Planetary Computer, Azure Cognitive Services y modelos tácticos profesionales
        </p>
      </div>
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="card">
              ...
              <div className="space-y-1 sm:space-y-2 text-xs sm:text-sm">
                ...
                <div className="flex items-center justify-between">
                  <span>Análisis de Vientos</span>
                  <span className="text-green-600">● Operativo</span>
                </div>
                <div className="flex items-center justify-between">
                  <span>Evaluación Biodiversidad</span>
                  <span className="text-green-600">● Operativo</span>
                </div>
                <div className="flex items-center justify-between">
                  <span>Planes Tácticos</span>
                  <span className="text-green-600">● Operativo</span>
                </div>
                <div className="flex items-center justify-between">
